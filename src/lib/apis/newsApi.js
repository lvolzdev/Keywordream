...
export const getNewsList = (stockCode) => {
    //TODO 추후에 실제 api와 연결
    const data = [
        {
            id:"1",
            title: "'번호이동 지원금' 오늘부터 최대 13만원까지",
            press: "노컷뉴스",
            date: "10분 전",
            imgUrl: "https://imgnews.pstatic.net/image/origin/079/2024/03/16/3874535.jpg?type=nf220_150",
        },
        {
            id:"2",
            title: "'번호이동 지원금' 오늘부터 최대 13만원까지",
